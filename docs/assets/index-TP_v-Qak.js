...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function Fx(n,t,e){const i=new Float32Array(ls),s=new I(0,1,0);return new Jn({name:"SphericalGaussianBlur",defines:{n:ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:ua(),fragmentShader:`
...
`)}const zv={[af]:"Linear",[lf]:"Reinhard",[cf]:"Cineon",[hf]:"ACESFilmic",[df]:"AgX",[ff]:"Neutral",[uf]:"Custom"};function kv(n,t){const e=zv[t];return e===void 0?(Lt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Mr=new I;function Vv(){Qt.getLuminanceCoefficients(Mr);const n=Mr.x.toFixed(4),t=Mr.y.toFixed(4),e=Mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,yb=[new I(1,0,0),new I(-1,0,0),new I(0,1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1)],Mb=[new I(0,-1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1),new I(0,-1,0),new I(0,-1,0)],Eu=new Se,ro=new I,rl=new I;function Sb(n,t,e){let i=new Hc;const s=new Mt,o=new Mt,r=new Te,a=new Ig,l=new Fg,c={},h=e.maxTextureSize,u={[ki]:gn,[gn]:ki,[ui]:ui},d=new Jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Mt},radius:{value:4}},vertexShader:vb,fragmentShader:bb}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const m=new _n;m.setAttribute("position",new jn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Cn(m,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=zr;let g=this.type;this.render=function(A,C,v){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;this.type===om&&(Lt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=zr);const T=n.getRenderTarget(),V=n.getActiveCubeFace(),w=n.getActiveMipmapLevel(),P=n.state;P.setBlending(_i),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);const O=g!==this.type;O&&C.traverse(function(k){k.material&&(Array.isArray(k.material)?k.material.forEach(F=>F.needsUpdate=!0):k.material.needsUpdate=!0)});for(let k=0,F=A.length;k<F;k++){const U=A[k],L=U.shadow;if(L===void 0){Lt("WebGLShadowMap:",U,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;s.copy(L.mapSize);const $=L.getFrameExtents();s.multiply($),o.copy(L.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(o.x=Math.floor(h/$.x),s.x=o.x*$.x,L.mapSize.x=o.x),s.y>h&&(o.y=Math.floor(h/$.y),s.y=o.y*$.y,L.mapSize.y=o.y));const X=n.state.buffers.depth.getReversed();if(L.camera._reversedDepth=X,L.map===null||O===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===po){if(U.isPointLight){Lt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new qn(s.x,s.y,{format:Xs,type:vi,minFilter:rn,magFilter:rn,generateMipmaps:!1}),L.map.texture.name=U.name+".shadowMap",L.map.depthTexture=new No(s.x,s.y,Wn),L.map.depthTexture.name=U.name+".shadowMapDepth",L.map.depthTexture.format=bi,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=$e,L.map.depthTexture.magFilter=$e}else U.isPointLight?(L.map=new zf(s.x),L.map.depthTexture=new dg(s.x,Kn)):(L.map=new qn(s.x,s.y),L.map.depthTexture=new No(s.x,s.y,Kn)),L.map.depthTexture.name=U.name+".shadowMap",L.map.depthTexture.format=bi,this.type===zr?(L.map.depthTexture.compareFunction=X?zc:Bc,L.map.depthTexture.minFilter=rn,L.map.depthTexture.magFilter=rn):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=$e,L.map.depthTexture.magFilter=$e);L.camera.updateProjectionMatrix()}const J=L.map.isWebGLCubeRenderTarget?6:1;for(let nt=0;nt<J;nt++){if(L.map.isWebGLCubeRenderTarget)n.setRenderTarget(L.map,nt),n.clear();else{nt===0&&(n.setRenderTarget(L.map),n.clear());const Q=L.getViewport(nt);r.set(o.x*Q.x,o.y*Q.y,o.x*Q.z,o.y*Q.w),P.viewport(r)}if(U.isPointLight){const Q=L.camera,mt=L.matrix,It=U.distance||Q.far;It!==Q.far&&(Q.far=It,Q.updateProjectionMatrix()),ro.setFromMatrixPosition(U.matrixWorld),Q.position.copy(ro),rl.copy(Q.position),rl.add(yb[nt]),Q.up.copy(Mb[nt]),Q.lookAt(rl),Q.updateMatrixWorld(),mt.makeTranslation(-ro.x,-ro.y,-ro.z),Eu.multiplyMatrices(Q.projectionMatrix,Q.matrixWorldInverse),L._frustum.setFromProjectionMatrix(Eu,Q.coordinateSystem,Q.reversedDepth)}else L.updateMatrices(U);i=L.getFrustum(),M(C,v,L.camera,U,this.type)}L.isPointLightShadow!==!0&&this.type===po&&x(L,v),L.needsUpdate=!1}g=this.type,p.needsUpdate=!1,n.setRenderTarget(T,V,w)};function x(A,C){const v=t.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new qn(s.x,s.y,{format:Xs,type:vi})),d.uniforms.shadow_pass.value=A.map.depthTexture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(C,null,v,d,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(C,null,v,f,_,null)}function y(A,C,v,T){let V=null;const w=v.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(w!==void 0)V=w;else if(V=v.isPointLight===!0?l:a,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const P=V.uuid,O=C.uuid;let k=c[P];k===void 0&&(k={},c[P]=k);let F=k[O];F===void 0&&(F=V.clone(),k[O]=F,C.addEventListener("dispose",E)),V=F}if(V.visible=C.visible,V.wireframe=C.wireframe,T===po?V.side=C.shadowSide!==null?C.shadowSide:C.side:V.side=C.shadowSide!==null?C.shadowSide:u[C.side],V.alphaMap=C.alphaMap,V.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,V.map=C.map,V.clipShadows=C.clipShadows,V.clippingPlanes=C.clippingPlanes,V.clipIntersection=C.clipIntersection,V.displacementMap=C.displacementMap,V.displacementScale=C.displacementScale,V.displacementBias=C.displacementBias,V.wireframeLinewidth=C.wireframeLinewidth,V.linewidth=C.linewidth,v.isPointLight===!0&&V.isMeshDistanceMaterial===!0){const P=n.properties.get(V);P.light=v}return V}function M(A,C,v,T,V){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&V===po)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,A.matrixWorld);const O=t.update(A),k=A.material;if(Array.isArray(k)){const F=O.groups;for(let U=0,L=F.length;U<L;U++){const $=F[U],X=k[$.materialIndex];if(X&&X.visible){const J=y(A,X,T,V);A.onBeforeShadow(n,A,C,v,O,J,$),n.renderBufferDirect(v,null,O,J,A,$),A.onAfterShadow(n,A,C,v,O,J,$)}}}else if(k.visible){const F=y(A,k,T,V);A.onBeforeShadow(n,A,C,v,O,F,null),n.renderBufferDirect(v,null,O,F,A,null),A.onAfterShadow(n,A,C,v,O,F,null)}}const P=A.children;for(let O=0,k=P.length;O<k;O++)M(P[O],C,v,T,V)}function E(A){A.target.removeEventListener("dispose",E);for(const v in c){const T=c[v],V=A.target.uuid;V in T&&(T[V].dispose(),delete T[V])}}}function Eb(n,t){function e(){let N=!1;const lt=new Te;let ot=null;const pt=new Te(0,0,0,0);return{setMask:function(et){ot!==et&&!N&&(n.colorMask(et,et,et,et),ot=et)},setLocked:function(et){N=et},setClear:function(et,q,xt,Ot,ge){ge===!0&&(et*=Ot,q*=Ot,xt*=Ot),lt.set(et,q,xt,Ot),pt.equals(lt)===!1&&(n.clearColor(et,q,xt,Ot),pt.copy(lt))},reset:function(){N=!1,ot=null,pt.set(-1,0,0,0)}}}function i(){let N=!1,lt=!1,ot=null,pt=null,et=null;return{setReversed:function(q){if(lt!==q){const xt=t.get("EXT_clip_control");q?xt.clipControlEXT(xt.LOWER_LEFT_EXT,xt.ZERO_TO_ONE_EXT):xt.clipControlEXT(xt.LOWER_LEFT_EXT,xt.NEGATIVE_ONE_TO_ONE_EXT),lt=q;const Ot=et;et=null,this.setClear(Ot)}},getReversed:function(){return lt},setTest:function(q){q?it(n.DEPTH_TEST):rt(n.DEPTH_TEST)},setMask:function(q){ot!==q&&!N&&(n.depthMask(q),ot=q)},setFunc:function(q){if(lt&&(q=Bm[q]),pt!==q){switch(q){case wl:n.depthFunc(n.NEVER);break;case Cl:n.depthFunc(n.ALWAYS);break;case Rl:n.depthFunc(n.LESS);break;case Gs:n.depthFunc(n.LEQUAL);break;case Pl:n.depthFunc(n.EQUAL);break;case Dl:n.depthFunc(n.GEQUAL);break;case Ll:n.depthFunc(n.GREATER);break;case Il:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}pt=q}},setLocked:function(q){N=q},setClear:function(q){et!==q&&(et=q,lt&&(q=1-q),n.clearDepth(q))},reset:function(){N=!1,ot=null,pt=null,et=null,lt=!1}}}function s(){let N=!1,lt=null,ot=null,pt=null,et=null,q=null,xt=null,Ot=null,ge=null;return{setTest:function(re){N||(re?it(n.STENCIL_TEST):rt(n.STENCIL_TEST))},setMask:function(re){lt!==re&&!N&&(n.stencilMask(re),lt=re)},setFunc:function(re,Qn,ti){(ot!==re||pt!==Qn||et!==ti)&&(n.stencilFunc(re,Qn,ti),ot=re,pt=Qn,et=ti)},setOp:function(re,Qn,ti){(q!==re||xt!==Qn||Ot!==ti)&&(n.stencilOp(re,Qn,ti),q=re,xt=Qn,Ot=ti)},setLocked:function(re){N=re},setClear:function(re){ge!==re&&(n.clearStencil(re),ge=re)},reset:function(){N=!1,lt=null,ot=null,pt=null,et=null,q=null,xt=null,Ot=null,ge=null}}}const o=new e,r=new i,a=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],m=null,_=!1,p=null,g=null,x=null,y=null,M=null,E=null,A=null,C=new $t(0,0,0),v=0,T=!1,V=null,w=null,P=null,O=null,k=null;const F=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,L=0;const $=n.getParameter(n.VERSION);$.indexOf("WebGL")!==-1?(L=parseFloat(/^WebGL (\d)/.exec($)[1]),U=L>=1):$.indexOf("OpenGL ES")!==-1&&(L=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),U=L>=2);let X=null,J={};const nt=n.getParameter(n.SCISSOR_BOX),Q=n.getParameter(n.VIEWPORT),mt=new Te().fromArray(nt),It=new Te().fromArray(Q);function qt(N,lt,ot,pt){const et=new Uint8Array(4),q=n.createTexture();n.bindTexture(N,q),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let xt=0;xt<ot;xt++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(lt,0,n.RGBA,1,1,pt,0,n.RGBA,n.UNSIGNED_BYTE,et):n.texImage2D(lt+xt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,et);return q}const Y={};Y[n.TEXTURE_2D]=qt(n.TEXTURE_2D,n.TEXTURE_2D,1),Y[n.TEXTURE_CUBE_MAP]=qt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[n.TEXTURE_2D_ARRAY]=qt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Y[n.TEXTURE_3D]=qt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),o.setClear(0,0,0,1),r.setClear(1),a.setClear(0),it(n.DEPTH_TEST),r.setFunc(Gs),Vt(!1),Ce(Mh),it(n.CULL_FACE),oe(_i);function it(N){h[N]!==!0&&(n.enable(N),h[N]=!0)}function rt(N){h[N]!==!1&&(n.disable(N),h[N]=!1)}function Ut(N,lt){return u[N]!==lt?(n.bindFramebuffer(N,lt),u[N]=lt,N===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=lt),N===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=lt),!0):!1}function Rt(N,lt){let ot=f,pt=!1;if(N){ot=d.get(lt),ot===void 0&&(ot=[],d.set(lt,ot));const et=N.textures;if(ot.length!==et.length||ot[0]!==n.COLOR_ATTACHMENT0){for(let q=0,xt=et.length;q<xt;q++)ot[q]=n.COLOR_ATTACHMENT0+q;ot.length=et.length,pt=!0}}else ot[0]!==n.BACK&&(ot[0]=n.BACK,pt=!0);pt&&n.drawBuffers(ot)}function Ft(N){return m!==N?(n.useProgram(N),m=N,!0):!1}const We={[as]:n.FUNC_ADD,[am]:n.FUNC_SUBTRACT,[lm]:n.FUNC_REVERSE_SUBTRACT};We[cm]=n.MIN,We[hm]=n.MAX;const Zt={[um]:n.ZERO,[dm]:n.ONE,[fm]:n.SRC_COLOR,[Tl]:n.SRC_ALPHA,[vm]:n.SRC_ALPHA_SATURATE,[_m]:n.DST_COLOR,[mm]:n.DST_ALPHA,[pm]:n.ONE_MINUS_SRC_COLOR,[Al]:n.ONE_MINUS_SRC_ALPHA,[xm]:n.ONE_MINUS_DST_COLOR,[gm]:n.ONE_MINUS_DST_ALPHA,[bm]:n.CONSTANT_COLOR,[ym]:n.ONE_MINUS_CONSTANT_COLOR,[Mm]:n.CONSTANT_ALPHA,[Sm]:n.ONE_MINUS_CONSTANT_ALPHA};function oe(N,lt,ot,pt,et,q,xt,Ot,ge,re){if(N===_i){_===!0&&(rt(n.BLEND),_=!1);return}if(_===!1&&(it(n.BLEND),_=!0),N!==rm){if(N!==p||re!==T){if((g!==as||M!==as)&&(n.blendEquation(n.FUNC_ADD),g=as,M=as),re)switch(N){case zs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Sh:n.blendFunc(n.ONE,n.ONE);break;case Eh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Th:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:ne("WebGLState: Invalid blending: ",N);break}else switch(N){case zs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Sh:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Eh:ne("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Th:ne("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ne("WebGLState: Invalid blending: ",N);break}x=null,y=null,E=null,A=null,C.set(0,0,0),v=0,p=N,T=re}return}et=et||lt,q=q||ot,xt=xt||pt,(lt!==g||et!==M)&&(n.blendEquationSeparate(We[lt],We[et]),g=lt,M=et),(ot!==x||pt!==y||q!==E||xt!==A)&&(n.blendFuncSeparate(Zt[ot],Zt[pt],Zt[q],Zt[xt]),x=ot,y=pt,E=q,A=xt),(Ot.equals(C)===!1||ge!==v)&&(n.blendColor(Ot.r,Ot.g,Ot.b,ge),C.copy(Ot),v=ge),p=N,T=!1}function fe(N,lt){N.side===ui?rt(n.CULL_FACE):it(n.CULL_FACE);let ot=N.side===gn;lt&&(ot=!ot),Vt(ot),N.blending===zs&&N.transparent===!1?oe(_i):oe(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),r.setFunc(N.depthFunc),r.setTest(N.depthTest),r.setMask(N.depthWrite),o.setMask(N.colorWrite);const pt=N.stencilWrite;a.setTest(pt),pt&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),De(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?it(n.SAMPLE_ALPHA_TO_COVERAGE):rt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Vt(N){V!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),V=N)}function Ce(N){N!==im?(it(n.CULL_FACE),N!==w&&(N===Mh?n.cullFace(n.BACK):N===sm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):rt(n.CULL_FACE),w=N}function D(N){N!==P&&(U&&n.lineWidth(N),P=N)}function De(N,lt,ot){N?(it(n.POLYGON_OFFSET_FILL),(O!==lt||k!==ot)&&(O=lt,k=ot,r.getReversed()&&(lt=-lt),n.polygonOffset(lt,ot))):rt(n.POLYGON_OFFSET_FILL)}function se(N){N?it(n.SCISSOR_TEST):rt(n.SCISSOR_TEST)}function me(N){N===void 0&&(N=n.TEXTURE0+F-1),X!==N&&(n.activeTexture(N),X=N)}function St(N,lt,ot){ot===void 0&&(X===null?ot=n.TEXTURE0+F-1:ot=X);let pt=J[ot];pt===void 0&&(pt={type:void 0,texture:void 0},J[ot]=pt),(pt.type!==N||pt.texture!==lt)&&(X!==ot&&(n.activeTexture(ot),X=ot),n.bindTexture(N,lt||Y[N]),pt.type=N,pt.texture=lt)}function R(){const N=J[X];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function b(){try{n.compressedTexImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function B(){try{n.compressedTexImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function K(){try{n.texSubImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function Z(){try{n.texSubImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function j(){try{n.compressedTexSubImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function gt(){try{n.compressedTexSubImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function at(){try{n.texStorage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function wt(){try{n.texStorage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function Dt(){try{n.texImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function tt(){try{n.texImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function st(N){mt.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),mt.copy(N))}function _t(N){It.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),It.copy(N))}function vt(N,lt){let ot=c.get(lt);ot===void 0&&(ot=new WeakMap,c.set(lt,ot));let pt=ot.get(N);pt===void 0&&(pt=n.getUniformBlockIndex(lt,N.name),ot.set(N,pt))}function dt(N,lt){const pt=c.get(lt).get(N);l.get(lt)!==pt&&(n.uniformBlockBinding(lt,pt,N.__bindingPointIndex),l.set(lt,pt))}function Ht(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),r.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),h={},X=null,J={},u={},d=new WeakMap,f=[],m=null,_=!1,p=null,g=null,x=null,y=null,M=null,E=null,A=null,C=new $t(0,0,0),v=0,T=!1,V=null,w=null,P=null,O=null,k=null,mt.set(0,0,n.canvas.width,n.canvas.height),It.set(0,0,n.canvas.width,n.canvas.height),o.reset(),r.reset(),a.reset()}return{buffers:{color:o,depth:r,stencil:a},enable:it,disable:rt,bindFramebuffer:Ut,drawBuffers:Rt,useProgram:Ft,setBlending:oe,setMaterial:fe,setFlipSided:Vt,setCullFace:Ce,setLineWidth:D,setPolygonOffset:De,setScissorTest:se,activeTexture:me,bindTexture:St,unbindTexture:R,compressedTexImage2D:b,compressedTexImage3D:B,texImage2D:Dt,texImage3D:tt,updateUBOMapping:vt,uniformBlockBinding:dt,texStorage2D:at,texStorage3D:wt,texSubImage2D:K,texSubImage3D:Z,compressedTexSubImage2D:j,compressedTexSubImage3D:gt,scissor:st,viewport:_t,reset:Ht}}function Tb(n,t,e,i,s,o,r){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Mt,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(R,b){return f?new OffscreenCanvas(R,b):$r("canvas")}function _(R,b,B){let K=1;const Z=St(R);if((Z.width>B||Z.height>B)&&(K=B/Math.max(Z.width,Z.height)),K<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const j=Math.floor(K*Z.width),gt=Math.floor(K*Z.height);u===void 0&&(u=m(j,gt));const at=b?m(j,gt):u;return at.width=j,at.height=gt,at.getContext("2d").drawImage(R,0,0,j,gt),Lt("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+j+"x"+gt+")."),at}else return"data"in R&&Lt("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),R;return R}function p(R){return R.generateMipmaps}function g(R){n.generateMipmap(R)}function x(R){return R.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?n.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function y(R,b,B,K,Z=!1){if(R!==null){if(n[R]!==void 0)return n[R];Lt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let j=b;if(b===n.RED&&(B===n.FLOAT&&(j=n.R32F),B===n.HALF_FLOAT&&(j=n.R16F),B===n.UNSIGNED_BYTE&&(j=n.R8)),b===n.RED_INTEGER&&(B===n.UNSIGNED_BYTE&&(j=n.R8UI),B===n.UNSIGNED_SHORT&&(j=n.R16UI),B===n.UNSIGNED_INT&&(j=n.R32UI),B===n.BYTE&&(j=n.R8I),B===n.SHORT&&(j=n.R16I),B===n.INT&&(j=n.R32I)),b===n.RG&&(B===n.FLOAT&&(j=n.RG32F),B===n.HALF_FLOAT&&(j=n.RG16F),B===n.UNSIGNED_BYTE&&(j=n.RG8)),b===n.RG_INTEGER&&(B===n.UNSIGNED_BYTE&&(j=n.RG8UI),B===n.UNSIGNED_SHORT&&(j=n.RG16UI),B===n.UNSIGNED_INT&&(j=n.RG32UI),B===n.BYTE&&(j=n.RG8I),B===n.SHORT&&(j=n.RG16I),B===n.INT&&(j=n.RG32I)),b===n.RGB_INTEGER&&(B===n.UNSIGNED_BYTE&&(j=n.RGB8UI),B===n.UNSIGNED_SHORT&&(j=n.RGB16UI),B===n.UNSIGNED_INT&&(j=n.RGB32UI),B===n.BYTE&&(j=n.RGB8I),B===n.SHORT&&(j=n.RGB16I),B===n.INT&&(j=n.RGB32I)),b===n.RGBA_INTEGER&&(B===n.UNSIGNED_BYTE&&(j=n.RGBA8UI),B===n.UNSIGNED_SHORT&&(j=n.RGBA16UI),B===n.UNSIGNED_INT&&(j=n.RGBA32UI),B===n.BYTE&&(j=n.RGBA8I),B===n.SHORT&&(j=n.RGBA16I),B===n.INT&&(j=n.RGBA32I)),b===n.RGB&&(B===n.UNSIGNED_INT_5_9_9_9_REV&&(j=n.RGB9_E5),B===n.UNSIGNED_INT_10F_11F_11F_REV&&(j=n.R11F_G11F_B10F)),b===n.RGBA){const gt=Z?jr:Qt.getTransfer(K);B===n.FLOAT&&(j=n.RGBA32F),B===n.HALF_FLOAT&&(j=n.RGBA16F),B===n.UNSIGNED_BYTE&&(j=gt===ae?n.SRGB8_ALPHA8:n.RGBA8),B===n.UNSIGNED_SHORT_4_4_4_4&&(j=n.RGBA4),B===n.UNSIGNED_SHORT_5_5_5_1&&(j=n.RGB5_A1)}return(j===n.R16F||j===n.R32F||j===n.RG16F||j===n.RG32F||j===n.RGBA16F||j===n.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function M(R,b){let B;return R?b===null||b===Kn||b===Fo?B=n.DEPTH24_STENCIL8:b===Wn?B=n.DEPTH32F_STENCIL8:b===Io&&(B=n.DEPTH24_STENCIL8,Lt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Kn||b===Fo?B=n.DEPTH_COMPONENT24:b===Wn?B=n.DEPTH_COMPONENT32F:b===Io&&(B=n.DEPTH_COMPONENT16),B}function E(R,b){return p(R)===!0||R.isFramebufferTexture&&R.minFilter!==$e&&R.minFilter!==rn?Math.log2(Math.max(b.width,b.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?b.mipmaps.length:1}function A(R){const b=R.target;b.removeEventListener("dispose",A),v(b),b.isVideoTexture&&h.delete(b)}function C(R){const b=R.target;b.removeEventListener("dispose",C),V(b)}function v(R){const b=i.get(R);if(b.__webglInit===void 0)return;const B=R.source,K=d.get(B);if(K){const Z=K[b.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&T(R),Object.keys(K).length===0&&d.delete(B)}i.remove(R)}function T(R){const b=i.get(R);n.deleteTexture(b.__webglTexture);const B=R.source,K=d.get(B);delete K[b.__cacheKey],r.memory.textures--}function V(R){const b=i.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),i.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(b.__webglFramebuffer[K]))for(let Z=0;Z<b.__webglFramebuffer[K].length;Z++)n.deleteFramebuffer(b.__webglFramebuffer[K][Z]);else n.deleteFramebuffer(b.__webglFramebuffer[K]);b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer[K])}else{if(Array.isArray(b.__webglFramebuffer))for(let K=0;K<b.__webglFramebuffer.length;K++)n.deleteFramebuffer(b.__webglFramebuffer[K]);else n.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&n.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let K=0;K<b.__webglColorRenderbuffer.length;K++)b.__webglColorRenderbuffer[K]&&n.deleteRenderbuffer(b.__webglColorRenderbuffer[K]);b.__webglDepthRenderbuffer&&n.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const B=R.textures;for(let K=0,Z=B.length;K<Z;K++){const j=i.get(B[K]);j.__webglTexture&&(n.deleteTexture(j.__webglTexture),r.memory.textures--),i.remove(B[K])}i.remove(R)}let w=0;function P(){w=0}function O(){const R=w;return R>=s.maxTextures&&Lt("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+s.maxTextures),w+=1,R}function k(R){const b=[];return b.push(R.wrapS),b.push(R.wrapT),b.push(R.wrapR||0),b.push(R.magFilter),b.push(R.minFilter),b.push(R.anisotropy),b.push(R.internalFormat),b.push(R.format),b.push(R.type),b.push(R.generateMipmaps),b.push(R.premultiplyAlpha),b.push(R.flipY),b.push(R.unpackAlignment),b.push(R.colorSpace),b.join()}function F(R,b){const B=i.get(R);if(R.isVideoTexture&&se(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&B.__version!==R.version){const K=R.image;if(K===null)Lt("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)Lt("WebGLRenderer: Texture marked for update but image is incomplete");else{Y(B,R,b);return}}else R.isExternalTexture&&(B.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(n.TEXTURE_2D,B.__webglTexture,n.TEXTURE0+b)}function U(R,b){const B=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){Y(B,R,b);return}else R.isExternalTexture&&(B.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(n.TEXTURE_2D_ARRAY,B.__webglTexture,n.TEXTURE0+b)}function L(R,b){const B=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){Y(B,R,b);return}e.bindTexture(n.TEXTURE_3D,B.__webglTexture,n.TEXTURE0+b)}function $(R,b){const B=i.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&B.__version!==R.version){it(B,R,b);return}e.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture,n.TEXTURE0+b)}const X={[Fl]:n.REPEAT,[fi]:n.CLAMP_TO_EDGE,[Ol]:n.MIRRORED_REPEAT},J={[$e]:n.NEAREST,[Am]:n.NEAREST_MIPMAP_NEAREST,[Zo]:n.NEAREST_MIPMAP_LINEAR,[rn]:n.LINEAR,[Ta]:n.LINEAR_MIPMAP_NEAREST,[cs]:n.LINEAR_MIPMAP_LINEAR},nt={[Rm]:n.NEVER,[Fm]:n.ALWAYS,[Pm]:n.LESS,[Bc]:n.LEQUAL,[Dm]:n.EQUAL,[zc]:n.GEQUAL,[Lm]:n.GREATER,[Im]:n.NOTEQUAL};function Q(R,b){if(b.type===Wn&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===rn||b.magFilter===Ta||b.magFilter===Zo||b.magFilter===cs||b.minFilter===rn||b.minFilter===Ta||b.minFilter===Zo||b.minFilter===cs)&&Lt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(R,n.TEXTURE_WRAP_S,X[b.wrapS]),n.texParameteri(R,n.TEXTURE_WRAP_T,X[b.wrapT]),(R===n.TEXTURE_3D||R===n.TEXTURE_2D_ARRAY)&&n.texParameteri(R,n.TEXTURE_WRAP_R,X[b.wrapR]),n.texParameteri(R,n.TEXTURE_MAG_FILTER,J[b.magFilter]),n.texParameteri(R,n.TEXTURE_MIN_FILTER,J[b.minFilter]),b.compareFunction&&(n.texParameteri(R,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(R,n.TEXTURE_COMPARE_FUNC,nt[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===$e||b.minFilter!==Zo&&b.minFilter!==cs||b.type===Wn&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");n.texParameterf(R,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function mt(R,b){let B=!1;R.__webglInit===void 0&&(R.__webglInit=!0,b.addEventListener("dispose",A));const K=b.source;let Z=d.get(K);Z===void 0&&(Z={},d.set(K,Z));const j=k(b);if(j!==R.__cacheKey){Z[j]===void 0&&(Z[j]={texture:n.createTexture(),usedTimes:0},r.memory.textures++,B=!0),Z[j].usedTimes++;const gt=Z[R.__cacheKey];gt!==void 0&&(Z[R.__cacheKey].usedTimes--,gt.usedTimes===0&&T(b)),R.__cacheKey=j,R.__webglTexture=Z[j].texture}return B}function It(R,b,B){return Math.floor(Math.floor(R/B)/b)}function qt(R,b,B,K){const j=R.updateRanges;if(j.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,b.width,b.height,B,K,b.data);else{j.sort((tt,st)=>tt.start-st.start);let gt=0;for(let tt=1;tt<j.length;tt++){const st=j[gt],_t=j[tt],vt=st.start+st.count,dt=It(_t.start,b.width,4),Ht=It(st.start,b.width,4);_t.start<=vt+1&&dt===Ht&&It(_t.start+_t.count-1,b.width,4)===dt?st.count=Math.max(st.count,_t.start+_t.count-st.start):(++gt,j[gt]=_t)}j.length=gt+1;const at=n.getParameter(n.UNPACK_ROW_LENGTH),wt=n.getParameter(n.UNPACK_SKIP_PIXELS),Dt=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,b.width);for(let tt=0,st=j.length;tt<st;tt++){const _t=j[tt],vt=Math.floor(_t.start/4),dt=Math.ceil(_t.count/4),Ht=vt%b.width,N=Math.floor(vt/b.width),lt=dt,ot=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Ht),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),e.texSubImage2D(n.TEXTURE_2D,0,Ht,N,lt,ot,B,K,b.data)}R.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,at),n.pixelStorei(n.UNPACK_SKIP_PIXELS,wt),n.pixelStorei(n.UNPACK_SKIP_ROWS,Dt)}}function Y(R,b,B){let K=n.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(K=n.TEXTURE_2D_ARRAY),b.isData3DTexture&&(K=n.TEXTURE_3D);const Z=mt(R,b),j=b.source;e.bindTexture(K,R.__webglTexture,n.TEXTURE0+B);const gt=i.get(j);if(j.version!==gt.__version||Z===!0){e.activeTexture(n.TEXTURE0+B);const at=Qt.getPrimaries(Qt.workingColorSpace),wt=b.colorSpace===Li?null:Qt.getPrimaries(b.colorSpace),Dt=b.colorSpace===Li||at===wt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Dt);let tt=_(b.image,!1,s.maxTextureSize);tt=me(b,tt);const st=o.convert(b.format,b.colorSpace),_t=o.convert(b.type);let vt=y(b.internalFormat,st,_t,b.colorSpace,b.isVideoTexture);Q(K,b);let dt;const Ht=b.mipmaps,N=b.isVideoTexture!==!0,lt=gt.__version===void 0||Z===!0,ot=j.dataReady,pt=E(b,tt);if(b.isDepthTexture)vt=M(b.format===hs,b.type),lt&&(N?e.texStorage2D(n.TEXTURE_2D,1,vt,tt.width,tt.height):e.texImage2D(n.TEXTURE_2D,0,vt,tt.width,tt.height,0,st,_t,null));else if(b.isDataTexture)if(Ht.length>0){N&&lt&&e.texStorage2D(n.TEXTURE_2D,pt,vt,Ht[0].width,Ht[0].height);for(let et=0,q=Ht.length;et<q;et++)dt=Ht[et],N?ot&&e.texSubImage2D(n.TEXTURE_2D,et,0,0,dt.width,dt.height,st,_t,dt.data):e.texImage2D(n.TEXTURE_2D,et,vt,dt.width,dt.height,0,st,_t,dt.data);b.generateMipmaps=!1}else N?(lt&&e.texStorage2D(n.TEXTURE_2D,pt,vt,tt.width,tt.height),ot&&qt(b,tt,st,_t)):e.texImage2D(n.TEXTURE_2D,0,vt,tt.width,tt.height,0,st,_t,tt.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){N&&lt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,pt,vt,Ht[0].width,Ht[0].height,tt.depth);for(let et=0,q=Ht.length;et<q;et++)if(dt=Ht[et],b.format!==On)if(st!==null)if(N){if(ot)if(b.layerUpdates.size>0){const xt=eu(dt.width,dt.height,b.format,b.type);for(const Ot of b.layerUpdates){const ge=dt.data.subarray(Ot*xt/dt.data.BYTES_PER_ELEMENT,(Ot+1)*xt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,et,0,0,Ot,dt.width,dt.height,1,st,ge)}b.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,et,0,0,0,dt.width,dt.height,tt.depth,st,dt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,et,vt,dt.width,dt.height,tt.depth,0,dt.data,0,0);else Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?ot&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,et,0,0,0,dt.width,dt.height,tt.depth,st,_t,dt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,et,vt,dt.width,dt.height,tt.depth,0,st,_t,dt.data)}else{N&&lt&&e.texStorage2D(n.TEXTURE_2D,pt,vt,Ht[0].width,Ht[0].height);for(let et=0,q=Ht.length;et<q;et++)dt=Ht[et],b.format!==On?st!==null?N?ot&&e.compressedTexSubImage2D(n.TEXTURE_2D,et,0,0,dt.width,dt.height,st,dt.data):e.compressedTexImage2D(n.TEXTURE_2D,et,vt,dt.width,dt.height,0,dt.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?ot&&e.texSubImage2D(n.TEXTURE_2D,et,0,0,dt.width,dt.height,st,_t,dt.data):e.texImage2D(n.TEXTURE_2D,et,vt,dt.width,dt.height,0,st,_t,dt.data)}else if(b.isDataArrayTexture)if(N){if(lt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,pt,vt,tt.width,tt.height,tt.depth),ot)if(b.layerUpdates.size>0){const et=eu(tt.width,tt.height,b.format,b.type);for(const q of b.layerUpdates){const xt=tt.data.subarray(q*et/tt.data.BYTES_PER_ELEMENT,(q+1)*et/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,q,tt.width,tt.height,1,st,_t,xt)}b.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,st,_t,tt.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,vt,tt.width,tt.height,tt.depth,0,st,_t,tt.data);else if(b.isData3DTexture)N?(lt&&e.texStorage3D(n.TEXTURE_3D,pt,vt,tt.width,tt.height,tt.depth),ot&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,st,_t,tt.data)):e.texImage3D(n.TEXTURE_3D,0,vt,tt.width,tt.height,tt.depth,0,st,_t,tt.data);else if(b.isFramebufferTexture){if(lt)if(N)e.texStorage2D(n.TEXTURE_2D,pt,vt,tt.width,tt.height);else{let et=tt.width,q=tt.height;for(let xt=0;xt<pt;xt++)e.texImage2D(n.TEXTURE_2D,xt,vt,et,q,0,st,_t,null),et>>=1,q>>=1}}else if(Ht.length>0){if(N&&lt){const et=St(Ht[0]);e.texStorage2D(n.TEXTURE_2D,pt,vt,et.width,et.height)}for(let et=0,q=Ht.length;et<q;et++)dt=Ht[et],N?ot&&e.texSubImage2D(n.TEXTURE_2D,et,0,0,st,_t,dt):e.texImage2D(n.TEXTURE_2D,et,vt,st,_t,dt);b.generateMipmaps=!1}else if(N){if(lt){const et=St(tt);e.texStorage2D(n.TEXTURE_2D,pt,vt,et.width,et.height)}ot&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,st,_t,tt)}else e.texImage2D(n.TEXTURE_2D,0,vt,st,_t,tt);p(b)&&g(K),gt.__version=j.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function it(R,b,B){if(b.image.length!==6)return;const K=mt(R,b),Z=b.source;e.bindTexture(n.TEXTURE_CUBE_MAP,R.__webglTexture,n.TEXTURE0+B);const j=i.get(Z);if(Z.version!==j.__version||K===!0){e.activeTexture(n.TEXTURE0+B);const gt=Qt.getPrimaries(Qt.workingColorSpace),at=b.colorSpace===Li?null:Qt.getPrimaries(b.colorSpace),wt=b.colorSpace===Li||gt===at?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,wt);const Dt=b.isCompressedTexture||b.image[0].isCompressedTexture,tt=b.image[0]&&b.image[0].isDataTexture,st=[];for(let q=0;q<6;q++)!Dt&&!tt?st[q]=_(b.image[q],!0,s.maxCubemapSize):st[q]=tt?b.image[q].image:b.image[q],st[q]=me(b,st[q]);const _t=st[0],vt=o.convert(b.format,b.colorSpace),dt=o.convert(b.type),Ht=y(b.internalFormat,vt,dt,b.colorSpace),N=b.isVideoTexture!==!0,lt=j.__version===void 0||K===!0,ot=Z.dataReady;let pt=E(b,_t);Q(n.TEXTURE_CUBE_MAP,b);let et;if(Dt){N&&lt&&e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,_t.width,_t.height);for(let q=0;q<6;q++){et=st[q].mipmaps;for(let xt=0;xt<et.length;xt++){const Ot=et[xt];b.format!==On?vt!==null?N?ot&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,0,0,Ot.width,Ot.height,vt,Ot.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,Ht,Ot.width,Ot.height,0,Ot.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,0,0,Ot.width,Ot.height,vt,dt,Ot.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,Ht,Ot.width,Ot.height,0,vt,dt,Ot.data)}}}else{if(et=b.mipmaps,N&&lt){et.length>0&&pt++;const q=St(st[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,q.width,q.height)}for(let q=0;q<6;q++)if(tt){N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,st[q].width,st[q].height,vt,dt,st[q].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Ht,st[q].width,st[q].height,0,vt,dt,st[q].data);for(let xt=0;xt<et.length;xt++){const ge=et[xt].image[q].image;N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,0,0,ge.width,ge.height,vt,dt,ge.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,Ht,ge.width,ge.height,0,vt,dt,ge.data)}}else{N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,vt,dt,st[q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Ht,vt,dt,st[q]);for(let xt=0;xt<et.length;xt++){const Ot=et[xt];N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,0,0,vt,dt,Ot.image[q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,Ht,vt,dt,Ot.image[q])}}}p(b)&&g(n.TEXTURE_CUBE_MAP),j.__version=Z.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function rt(R,b,B,K,Z,j){const gt=o.convert(B.format,B.colorSpace),at=o.convert(B.type),wt=y(B.internalFormat,gt,at,B.colorSpace),Dt=i.get(b),tt=i.get(B);if(tt.__renderTarget=b,!Dt.__hasExternalTextures){const st=Math.max(1,b.width>>j),_t=Math.max(1,b.height>>j);Z===n.TEXTURE_3D||Z===n.TEXTURE_2D_ARRAY?e.texImage3D(Z,j,wt,st,_t,b.depth,0,gt,at,null):e.texImage2D(Z,j,wt,st,_t,0,gt,at,null)}e.bindFramebuffer(n.FRAMEBUFFER,R),De(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,K,Z,tt.__webglTexture,0,D(b)):(Z===n.TEXTURE_2D||Z>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,K,Z,tt.__webglTexture,j),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Ut(R,b,B){if(n.bindRenderbuffer(n.RENDERBUFFER,R),b.depthBuffer){const K=b.depthTexture,Z=K&&K.isDepthTexture?K.type:null,j=M(b.stencilBuffer,Z),gt=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;De(b)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(b),j,b.width,b.height):B?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(b),j,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,j,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,gt,n.RENDERBUFFER,R)}else{const K=b.textures;for(let Z=0;Z<K.length;Z++){const j=K[Z],gt=o.convert(j.format,j.colorSpace),at=o.convert(j.type),wt=y(j.internalFormat,gt,at,j.colorSpace);De(b)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(b),wt,b.width,b.height):B?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(b),wt,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,wt,b.width,b.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Rt(R,b,B){const K=b.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(n.FRAMEBUFFER,R),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=i.get(b.depthTexture);if(Z.__renderTarget=b,(!Z.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),K){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,b.depthTexture.addEventListener("dispose",A)),Z.__webglTexture===void 0){Z.__webglTexture=n.createTexture(),e.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),Q(n.TEXTURE_CUBE_MAP,b.depthTexture);const Dt=o.convert(b.depthTexture.format),tt=o.convert(b.depthTexture.type);let st;b.depthTexture.format===bi?st=n.DEPTH_COMPONENT24:b.depthTexture.format===hs&&(st=n.DEPTH24_STENCIL8);for(let _t=0;_t<6;_t++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,st,b.width,b.height,0,Dt,tt,null)}}else F(b.depthTexture,0);const j=Z.__webglTexture,gt=D(b),at=K?n.TEXTURE_CUBE_MAP_POSITIVE_X+B:n.TEXTURE_2D,wt=b.depthTexture.format===hs?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(b.depthTexture.format===bi)De(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,wt,at,j,0,gt):n.framebufferTexture2D(n.FRAMEBUFFER,wt,at,j,0);else if(b.depthTexture.format===hs)De(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,wt,at,j,0,gt):n.framebufferTexture2D(n.FRAMEBUFFER,wt,at,j,0);else throw new Error("Unknown depthTexture format")}function Ft(R){const b=i.get(R),B=R.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==R.depthTexture){const K=R.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),K){const Z=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,K.removeEventListener("dispose",Z)};K.addEventListener("dispose",Z),b.__depthDisposeCallback=Z}b.__boundDepthTexture=K}if(R.depthTexture&&!b.__autoAllocateDepthBuffer)if(B)for(let K=0;K<6;K++)Rt(b.__webglFramebuffer[K],R,K);else{const K=R.texture.mipmaps;K&&K.length>0?Rt(b.__webglFramebuffer[0],R,0):Rt(b.__webglFramebuffer,R,0)}else if(B){b.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[K]),b.__webglDepthbuffer[K]===void 0)b.__webglDepthbuffer[K]=n.createRenderbuffer(),Ut(b.__webglDepthbuffer[K],R,!1);else{const Z=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,j=b.__webglDepthbuffer[K];n.bindRenderbuffer(n.RENDERBUFFER,j),n.framebufferRenderbuffer(n.FRAMEBUFFER,Z,n.RENDERBUFFER,j)}}else{const K=R.texture.mipmaps;if(K&&K.length>0?e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=n.createRenderbuffer(),Ut(b.__webglDepthbuffer,R,!1);else{const Z=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,j=b.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,j),n.framebufferRenderbuffer(n.FRAMEBUFFER,Z,n.RENDERBUFFER,j)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function We(R,b,B){const K=i.get(R);b!==void 0&&rt(K.__webglFramebuffer,R,R.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),B!==void 0&&Ft(R)}function Zt(R){const b=R.texture,B=i.get(R),K=i.get(b);R.addEventListener("dispose",C);const Z=R.textures,j=R.isWebGLCubeRenderTarget===!0,gt=Z.length>1;if(gt||(K.__webglTexture===void 0&&(K.__webglTexture=n.createTexture()),K.__version=b.version,r.memory.textures++),j){B.__webglFramebuffer=[];for(let at=0;at<6;at++)if(b.mipmaps&&b.mipmaps.length>0){B.__webglFramebuffer[at]=[];for(let wt=0;wt<b.mipmaps.length;wt++)B.__webglFramebuffer[at][wt]=n.createFramebuffer()}else B.__webglFramebuffer[at]=n.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){B.__webglFramebuffer=[];for(let at=0;at<b.mipmaps.length;at++)B.__webglFramebuffer[at]=n.createFramebuffer()}else B.__webglFramebuffer=n.createFramebuffer();if(gt)for(let at=0,wt=Z.length;at<wt;at++){const Dt=i.get(Z[at]);Dt.__webglTexture===void 0&&(Dt.__webglTexture=n.createTexture(),r.memory.textures++)}if(R.samples>0&&De(R)===!1){B.__webglMultisampledFramebuffer=n.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let at=0;at<Z.length;at++){const wt=Z[at];B.__webglColorRenderbuffer[at]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,B.__webglColorRenderbuffer[at]);const Dt=o.convert(wt.format,wt.colorSpace),tt=o.convert(wt.type),st=y(wt.internalFormat,Dt,tt,wt.colorSpace,R.isXRRenderTarget===!0),_t=D(R);n.renderbufferStorageMultisample(n.RENDERBUFFER,_t,st,R.width,R.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.RENDERBUFFER,B.__webglColorRenderbuffer[at])}n.bindRenderbuffer(n.RENDERBUFFER,null),R.depthBuffer&&(B.__webglDepthRenderbuffer=n.createRenderbuffer(),Ut(B.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(j){e.bindTexture(n.TEXTURE_CUBE_MAP,K.__webglTexture),Q(n.TEXTURE_CUBE_MAP,b);for(let at=0;at<6;at++)if(b.mipmaps&&b.mipmaps.length>0)for(let wt=0;wt<b.mipmaps.length;wt++)rt(B.__webglFramebuffer[at][wt],R,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,wt);else rt(B.__webglFramebuffer[at],R,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(b)&&g(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(gt){for(let at=0,wt=Z.length;at<wt;at++){const Dt=Z[at],tt=i.get(Dt);let st=n.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(st=R.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(st,tt.__webglTexture),Q(st,Dt),rt(B.__webglFramebuffer,R,Dt,n.COLOR_ATTACHMENT0+at,st,0),p(Dt)&&g(st)}e.unbindTexture()}else{let at=n.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(at=R.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(at,K.__webglTexture),Q(at,b),b.mipmaps&&b.mipmaps.length>0)for(let wt=0;wt<b.mipmaps.length;wt++)rt(B.__webglFramebuffer[wt],R,b,n.COLOR_ATTACHMENT0,at,wt);else rt(B.__webglFramebuffer,R,b,n.COLOR_ATTACHMENT0,at,0);p(b)&&g(at),e.unbindTexture()}R.depthBuffer&&Ft(R)}function oe(R){const b=R.textures;for(let B=0,K=b.length;B<K;B++){const Z=b[B];if(p(Z)){const j=x(R),gt=i.get(Z).__webglTexture;e.bindTexture(j,gt),g(j),e.unbindTexture()}}}const fe=[],Vt=[];function Ce(R){if(R.samples>0){if(De(R)===!1){const b=R.textures,B=R.width,K=R.height;let Z=n.COLOR_BUFFER_BIT;const j=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,gt=i.get(R),at=b.length>1;if(at)for(let Dt=0;Dt<b.length;Dt++)e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);const wt=R.texture.mipmaps;wt&&wt.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let Dt=0;Dt<b.length;Dt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(Z|=n.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(Z|=n.STENCIL_BUFFER_BIT)),at){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,gt.__webglColorRenderbuffer[Dt]);const tt=i.get(b[Dt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,tt,0)}n.blitFramebuffer(0,0,B,K,0,0,B,K,Z,n.NEAREST),l===!0&&(fe.length=0,Vt.length=0,fe.push(n.COLOR_ATTACHMENT0+Dt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(fe.push(j),Vt.push(j),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Vt)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,fe))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),at)for(let Dt=0;Dt<b.length;Dt++){e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.RENDERBUFFER,gt.__webglColorRenderbuffer[Dt]);const tt=i.get(b[Dt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.TEXTURE_2D,tt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const b=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[b])}}}function D(R){return Math.min(s.maxSamples,R.samples)}function De(R){const b=i.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function se(R){const b=r.render.frame;h.get(R)!==b&&(h.set(R,b),R.update())}function me(R,b){const B=R.colorSpace,K=R.format,Z=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||B!==Ys&&B!==Li&&(Qt.getTransfer(B)===ae?(K!==On||Z!==Mn)&&Lt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ne("WebGLTextures: Unsupported texture color space:",B)),b}function St(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=P,this.setTexture2D=F,this.setTexture2DArray=U,this.setTexture3D=L,this.setTextureCube=$,this.rebindTextures=We,this.setupRenderTarget=Zt,this.updateRenderTargetMipmap=oe,this.updateMultisampleRenderTarget=Ce,this.setupDepthRenderbuffer=Ft,this.setupFrameBufferTexture=rt,this.useMultisampledRTT=De,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Ab(n,t){function e(i,s=Li){let o;const r=Qt.getTransfer(s);if(i===Mn)return n.UNSIGNED_BYTE;if(i===Ic)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Fc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===_f)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===xf)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===mf)return n.BYTE;if(i===gf)return n.SHORT;if(i===Io)return n.UNSIGNED_SHORT;if(i===Lc)return n.INT;if(i===Kn)return n.UNSIGNED_INT;if(i===Wn)return n.FLOAT;if(i===vi)return n.HALF_FLOAT;if(i===vf)return n.ALPHA;if(i===bf)return n.RGB;if(i===On)return n.RGBA;if(i===bi)return n.DEPTH_COMPONENT;if(i===hs)return n.DEPTH_STENCIL;if(i===yf)return n.RED;if(i===Oc)return n.RED_INTEGER;if(i===Xs)return n.RG;if(i===Nc)return n.RG_INTEGER;if(i===Uc)return n.RGBA_INTEGER;if(i===kr||i===Vr||i===Hr||i===Gr)if(r===ae)if(o=t.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(i===kr)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Vr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Hr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Gr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=t.get("WEBGL_compressed_texture_s3tc"),o!==null){if(i===kr)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Vr)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Hr)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Gr)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Nl||i===Ul||i===Bl||i===zl)if(o=t.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(i===Nl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ul)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Bl)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===zl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===kl||i===Vl||i===Hl||i===Gl||i===Wl||i===Xl||i===Yl)if(o=t.get("WEBGL_compressed_texture_etc"),o!==null){if(i===kl||i===Vl)return r===ae?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(i===Hl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC;if(i===Gl)return o.COMPRESSED_R11_EAC;if(i===Wl)return o.COMPRESSED_SIGNED_R11_EAC;if(i===Xl)return o.COMPRESSED_RG11_EAC;if(i===Yl)return o.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===ql||i===jl||i===$l||i===Kl||i===Zl||i===Jl||i===Ql||i===tc||i===ec||i===nc||i===ic||i===sc||i===oc||i===rc)if(o=t.get("WEBGL_compressed_texture_astc"),o!==null){if(i===ql)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===jl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===$l)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Kl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Zl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Jl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ql)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===tc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ec)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===nc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ic)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===sc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===oc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===rc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ac||i===lc||i===cc)if(o=t.get("EXT_texture_compression_bptc"),o!==null){if(i===ac)return r===ae?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===lc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===cc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===hc||i===uc||i===dc||i===fc)if(o=t.get("EXT_texture_compression_rgtc"),o!==null){if(i===hc)return o.COMPRESSED_RED_RGTC1_EXT;if(i===uc)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===dc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===fc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Fo?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const wb=`
void main() {
