...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gi,depthTest:!1,depthWrite:!1})}function Fx(n,t,e){const i=new Float32Array(cs),s=new F(0,1,0);return new Zn({name:"SphericalGaussianBlur",defines:{n:cs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:da(),fragmentShader:`
	...
	`}class zf extends Yn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const i={width:t,height:t,depth:1},s=[i,i,i,i,i,i];this.texture=new Df(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const zv={[af]:"Linear",[lf]:"Reinhard",[cf]:"Cineon",[hf]:"ACESFilmic",[df]:"AgX",[ff]:"Neutral",[uf]:"Custom"};function kv(n,t){const e=zv[t];return e===void 0?(Lt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Sr=new F;function Vv(){Qt.getLuminanceCoefficients(Sr);const n=Sr.x.toFixed(4),t=Sr.y.toFixed(4),e=Sr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,yb=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],Mb=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],Eu=new Se,ao=new F,al=new F;function Sb(n,t,e){let i=new Hc;const s=new Mt,o=new Mt,r=new Te,a=new Ig,l=new Fg,c={},h=e.maxTextureSize,u={[ki]:gn,[gn]:ki,[hi]:hi},d=new Zn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Mt},radius:{value:4}},vertexShader:vb,fragmentShader:bb}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const m=new _n;m.setAttribute("position",new qn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new wn(m,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=kr;let g=this.type;this.render=function(A,C,v){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;this.type===om&&(Lt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=kr);const E=n.getRenderTarget(),V=n.getActiveCubeFace(),w=n.getActiveMipmapLevel(),P=n.state;P.setBlending(gi),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);const O=g!==this.type;O&&C.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(I=>I.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,I=A.length;B<I;B++){const U=A[B],L=U.shadow;if(L===void 0){Lt("WebGLShadowMap:",U,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;s.copy(L.mapSize);const K=L.getFrameExtents();s.multiply(K),o.copy(L.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(o.x=Math.floor(h/K.x),s.x=o.x*K.x,L.mapSize.x=o.x),s.y>h&&(o.y=Math.floor(h/K.y),s.y=o.y*K.y,L.mapSize.y=o.y));const Y=n.state.buffers.depth.getReversed();if(L.camera._reversedDepth=Y,L.map===null||O===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===mo){if(U.isPointLight){Lt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new Yn(s.x,s.y,{format:Ys,type:xi,minFilter:rn,magFilter:rn,generateMipmaps:!1}),L.map.texture.name=U.name+".shadowMap",L.map.depthTexture=new Uo(s.x,s.y,Gn),L.map.depthTexture.name=U.name+".shadowMapDepth",L.map.depthTexture.format=vi,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=$e,L.map.depthTexture.magFilter=$e}else U.isPointLight?(L.map=new zf(s.x),L.map.depthTexture=new dg(s.x,$n)):(L.map=new Yn(s.x,s.y),L.map.depthTexture=new Uo(s.x,s.y,$n)),L.map.depthTexture.name=U.name+".shadowMap",L.map.depthTexture.format=vi,this.type===kr?(L.map.depthTexture.compareFunction=Y?zc:Bc,L.map.depthTexture.minFilter=rn,L.map.depthTexture.magFilter=rn):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=$e,L.map.depthTexture.magFilter=$e);L.camera.updateProjectionMatrix()}const J=L.map.isWebGLCubeRenderTarget?6:1;for(let nt=0;nt<J;nt++){if(L.map.isWebGLCubeRenderTarget)n.setRenderTarget(L.map,nt),n.clear();else{nt===0&&(n.setRenderTarget(L.map),n.clear());const et=L.getViewport(nt);r.set(o.x*et.x,o.y*et.y,o.x*et.z,o.y*et.w),P.viewport(r)}if(U.isPointLight){const et=L.camera,mt=L.matrix,It=U.distance||et.far;It!==et.far&&(et.far=It,et.updateProjectionMatrix()),ao.setFromMatrixPosition(U.matrixWorld),et.position.copy(ao),al.copy(et.position),al.add(yb[nt]),et.up.copy(Mb[nt]),et.lookAt(al),et.updateMatrixWorld(),mt.makeTranslation(-ao.x,-ao.y,-ao.z),Eu.multiplyMatrices(et.projectionMatrix,et.matrixWorldInverse),L._frustum.setFromProjectionMatrix(Eu,et.coordinateSystem,et.reversedDepth)}else L.updateMatrices(U);i=L.getFrustum(),M(C,v,L.camera,U,this.type)}L.isPointLightShadow!==!0&&this.type===mo&&x(L,v),L.needsUpdate=!1}g=this.type,p.needsUpdate=!1,n.setRenderTarget(E,V,w)};function x(A,C){const v=t.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Yn(s.x,s.y,{format:Ys,type:xi})),d.uniforms.shadow_pass.value=A.map.depthTexture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(C,null,v,d,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(C,null,v,f,_,null)}function y(A,C,v,E){let V=null;const w=v.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(w!==void 0)V=w;else if(V=v.isPointLight===!0?l:a,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const P=V.uuid,O=C.uuid;let B=c[P];B===void 0&&(B={},c[P]=B);let I=B[O];I===void 0&&(I=V.clone(),B[O]=I,C.addEventListener("dispose",T)),V=I}if(V.visible=C.visible,V.wireframe=C.wireframe,E===mo?V.side=C.shadowSide!==null?C.shadowSide:C.side:V.side=C.shadowSide!==null?C.shadowSide:u[C.side],V.alphaMap=C.alphaMap,V.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,V.map=C.map,V.clipShadows=C.clipShadows,V.clippingPlanes=C.clippingPlanes,V.clipIntersection=C.clipIntersection,V.displacementMap=C.displacementMap,V.displacementScale=C.displacementScale,V.displacementBias=C.displacementBias,V.wireframeLinewidth=C.wireframeLinewidth,V.linewidth=C.linewidth,v.isPointLight===!0&&V.isMeshDistanceMaterial===!0){const P=n.properties.get(V);P.light=v}return V}function M(A,C,v,E,V){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&V===mo)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,A.matrixWorld);const O=t.update(A),B=A.material;if(Array.isArray(B)){const I=O.groups;for(let U=0,L=I.length;U<L;U++){const K=I[U],Y=B[K.materialIndex];if(Y&&Y.visible){const J=y(A,Y,E,V);A.onBeforeShadow(n,A,C,v,O,J,K),n.renderBufferDirect(v,null,O,J,A,K),A.onAfterShadow(n,A,C,v,O,J,K)}}}else if(B.visible){const I=y(A,B,E,V);A.onBeforeShadow(n,A,C,v,O,I,null),n.renderBufferDirect(v,null,O,I,A,null),A.onAfterShadow(n,A,C,v,O,I,null)}}const P=A.children;for(let O=0,B=P.length;O<B;O++)M(P[O],C,v,E,V)}function T(A){A.target.removeEventListener("dispose",T);for(const v in c){const E=c[v],V=A.target.uuid;V in E&&(E[V].dispose(),delete E[V])}}}function Eb(n,t){function e(){let N=!1;const lt=new Te;let ot=null;const pt=new Te(0,0,0,0);return{setMask:function(tt){ot!==tt&&!N&&(n.colorMask(tt,tt,tt,tt),ot=tt)},setLocked:function(tt){N=tt},setClear:function(tt,q,xt,Ot,ge){ge===!0&&(tt*=Ot,q*=Ot,xt*=Ot),lt.set(tt,q,xt,Ot),pt.equals(lt)===!1&&(n.clearColor(tt,q,xt,Ot),pt.copy(lt))},reset:function(){N=!1,ot=null,pt.set(-1,0,0,0)}}}function i(){let N=!1,lt=!1,ot=null,pt=null,tt=null;return{setReversed:function(q){if(lt!==q){const xt=t.get("EXT_clip_control");q?xt.clipControlEXT(xt.LOWER_LEFT_EXT,xt.ZERO_TO_ONE_EXT):xt.clipControlEXT(xt.LOWER_LEFT_EXT,xt.NEGATIVE_ONE_TO_ONE_EXT),lt=q;const Ot=tt;tt=null,this.setClear(Ot)}},getReversed:function(){return lt},setTest:function(q){q?it(n.DEPTH_TEST):rt(n.DEPTH_TEST)},setMask:function(q){ot!==q&&!N&&(n.depthMask(q),ot=q)},setFunc:function(q){if(lt&&(q=Bm[q]),pt!==q){switch(q){case wl:n.depthFunc(n.NEVER);break;case Cl:n.depthFunc(n.ALWAYS);break;case Rl:n.depthFunc(n.LESS);break;case Ws:n.depthFunc(n.LEQUAL);break;case Pl:n.depthFunc(n.EQUAL);break;case Dl:n.depthFunc(n.GEQUAL);break;case Ll:n.depthFunc(n.GREATER);break;case Il:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}pt=q}},setLocked:function(q){N=q},setClear:function(q){tt!==q&&(tt=q,lt&&(q=1-q),n.clearDepth(q))},reset:function(){N=!1,ot=null,pt=null,tt=null,lt=!1}}}function s(){let N=!1,lt=null,ot=null,pt=null,tt=null,q=null,xt=null,Ot=null,ge=null;return{setTest:function(re){N||(re?it(n.STENCIL_TEST):rt(n.STENCIL_TEST))},setMask:function(re){lt!==re&&!N&&(n.stencilMask(re),lt=re)},setFunc:function(re,Jn,Qn){(ot!==re||pt!==Jn||tt!==Qn)&&(n.stencilFunc(re,Jn,Qn),ot=re,pt=Jn,tt=Qn)},setOp:function(re,Jn,Qn){(q!==re||xt!==Jn||Ot!==Qn)&&(n.stencilOp(re,Jn,Qn),q=re,xt=Jn,Ot=Qn)},setLocked:function(re){N=re},setClear:function(re){ge!==re&&(n.clearStencil(re),ge=re)},reset:function(){N=!1,lt=null,ot=null,pt=null,tt=null,q=null,xt=null,Ot=null,ge=null}}}const o=new e,r=new i,a=new s,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],m=null,_=!1,p=null,g=null,x=null,y=null,M=null,T=null,A=null,C=new $t(0,0,0),v=0,E=!1,V=null,w=null,P=null,O=null,B=null;const I=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,L=0;const K=n.getParameter(n.VERSION);K.indexOf("WebGL")!==-1?(L=parseFloat(/^WebGL (\d)/.exec(K)[1]),U=L>=1):K.indexOf("OpenGL ES")!==-1&&(L=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),U=L>=2);let Y=null,J={};const nt=n.getParameter(n.SCISSOR_BOX),et=n.getParameter(n.VIEWPORT),mt=new Te().fromArray(nt),It=new Te().fromArray(et);function jt(N,lt,ot,pt){const tt=new Uint8Array(4),q=n.createTexture();n.bindTexture(N,q),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let xt=0;xt<ot;xt++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(lt,0,n.RGBA,1,1,pt,0,n.RGBA,n.UNSIGNED_BYTE,tt):n.texImage2D(lt+xt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,tt);return q}const X={};X[n.TEXTURE_2D]=jt(n.TEXTURE_2D,n.TEXTURE_2D,1),X[n.TEXTURE_CUBE_MAP]=jt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),X[n.TEXTURE_2D_ARRAY]=jt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),X[n.TEXTURE_3D]=jt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),o.setClear(0,0,0,1),r.setClear(1),a.setClear(0),it(n.DEPTH_TEST),r.setFunc(Ws),Vt(!1),Ce(Mh),it(n.CULL_FACE),oe(gi);function it(N){h[N]!==!0&&(n.enable(N),h[N]=!0)}function rt(N){h[N]!==!1&&(n.disable(N),h[N]=!1)}function Ut(N,lt){return u[N]!==lt?(n.bindFramebuffer(N,lt),u[N]=lt,N===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=lt),N===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=lt),!0):!1}function Rt(N,lt){let ot=f,pt=!1;if(N){ot=d.get(lt),ot===void 0&&(ot=[],d.set(lt,ot));const tt=N.textures;if(ot.length!==tt.length||ot[0]!==n.COLOR_ATTACHMENT0){for(let q=0,xt=tt.length;q<xt;q++)ot[q]=n.COLOR_ATTACHMENT0+q;ot.length=tt.length,pt=!0}}else ot[0]!==n.BACK&&(ot[0]=n.BACK,pt=!0);pt&&n.drawBuffers(ot)}function Ft(N){return m!==N?(n.useProgram(N),m=N,!0):!1}const We={[ls]:n.FUNC_ADD,[am]:n.FUNC_SUBTRACT,[lm]:n.FUNC_REVERSE_SUBTRACT};We[cm]=n.MIN,We[hm]=n.MAX;const Zt={[um]:n.ZERO,[dm]:n.ONE,[fm]:n.SRC_COLOR,[Tl]:n.SRC_ALPHA,[vm]:n.SRC_ALPHA_SATURATE,[_m]:n.DST_COLOR,[mm]:n.DST_ALPHA,[pm]:n.ONE_MINUS_SRC_COLOR,[Al]:n.ONE_MINUS_SRC_ALPHA,[xm]:n.ONE_MINUS_DST_COLOR,[gm]:n.ONE_MINUS_DST_ALPHA,[bm]:n.CONSTANT_COLOR,[ym]:n.ONE_MINUS_CONSTANT_COLOR,[Mm]:n.CONSTANT_ALPHA,[Sm]:n.ONE_MINUS_CONSTANT_ALPHA};function oe(N,lt,ot,pt,tt,q,xt,Ot,ge,re){if(N===gi){_===!0&&(rt(n.BLEND),_=!1);return}if(_===!1&&(it(n.BLEND),_=!0),N!==rm){if(N!==p||re!==E){if((g!==ls||M!==ls)&&(n.blendEquation(n.FUNC_ADD),g=ls,M=ls),re)switch(N){case ks:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Sh:n.blendFunc(n.ONE,n.ONE);break;case Eh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Th:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:ne("WebGLState: Invalid blending: ",N);break}else switch(N){case ks:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Sh:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Eh:ne("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Th:ne("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ne("WebGLState: Invalid blending: ",N);break}x=null,y=null,T=null,A=null,C.set(0,0,0),v=0,p=N,E=re}return}tt=tt||lt,q=q||ot,xt=xt||pt,(lt!==g||tt!==M)&&(n.blendEquationSeparate(We[lt],We[tt]),g=lt,M=tt),(ot!==x||pt!==y||q!==T||xt!==A)&&(n.blendFuncSeparate(Zt[ot],Zt[pt],Zt[q],Zt[xt]),x=ot,y=pt,T=q,A=xt),(Ot.equals(C)===!1||ge!==v)&&(n.blendColor(Ot.r,Ot.g,Ot.b,ge),C.copy(Ot),v=ge),p=N,E=!1}function fe(N,lt){N.side===hi?rt(n.CULL_FACE):it(n.CULL_FACE);let ot=N.side===gn;lt&&(ot=!ot),Vt(ot),N.blending===ks&&N.transparent===!1?oe(gi):oe(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),r.setFunc(N.depthFunc),r.setTest(N.depthTest),r.setMask(N.depthWrite),o.setMask(N.colorWrite);const pt=N.stencilWrite;a.setTest(pt),pt&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),De(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?it(n.SAMPLE_ALPHA_TO_COVERAGE):rt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Vt(N){V!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),V=N)}function Ce(N){N!==im?(it(n.CULL_FACE),N!==w&&(N===Mh?n.cullFace(n.BACK):N===sm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):rt(n.CULL_FACE),w=N}function D(N){N!==P&&(U&&n.lineWidth(N),P=N)}function De(N,lt,ot){N?(it(n.POLYGON_OFFSET_FILL),(O!==lt||B!==ot)&&(O=lt,B=ot,r.getReversed()&&(lt=-lt),n.polygonOffset(lt,ot))):rt(n.POLYGON_OFFSET_FILL)}function se(N){N?it(n.SCISSOR_TEST):rt(n.SCISSOR_TEST)}function me(N){N===void 0&&(N=n.TEXTURE0+I-1),Y!==N&&(n.activeTexture(N),Y=N)}function St(N,lt,ot){ot===void 0&&(Y===null?ot=n.TEXTURE0+I-1:ot=Y);let pt=J[ot];pt===void 0&&(pt={type:void 0,texture:void 0},J[ot]=pt),(pt.type!==N||pt.texture!==lt)&&(Y!==ot&&(n.activeTexture(ot),Y=ot),n.bindTexture(N,lt||X[N]),pt.type=N,pt.texture=lt)}function R(){const N=J[Y];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function b(){try{n.compressedTexImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function z(){try{n.compressedTexImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function $(){try{n.texSubImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function Z(){try{n.texSubImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function j(){try{n.compressedTexSubImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function gt(){try{n.compressedTexSubImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function at(){try{n.texStorage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function wt(){try{n.texStorage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function Dt(){try{n.texImage2D(...arguments)}catch(N){ne("WebGLState:",N)}}function Q(){try{n.texImage3D(...arguments)}catch(N){ne("WebGLState:",N)}}function st(N){mt.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),mt.copy(N))}function _t(N){It.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),It.copy(N))}function bt(N,lt){let ot=c.get(lt);ot===void 0&&(ot=new WeakMap,c.set(lt,ot));let pt=ot.get(N);pt===void 0&&(pt=n.getUniformBlockIndex(lt,N.name),ot.set(N,pt))}function dt(N,lt){const pt=c.get(lt).get(N);l.get(lt)!==pt&&(n.uniformBlockBinding(lt,pt,N.__bindingPointIndex),l.set(lt,pt))}function Ht(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),r.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),h={},Y=null,J={},u={},d=new WeakMap,f=[],m=null,_=!1,p=null,g=null,x=null,y=null,M=null,T=null,A=null,C=new $t(0,0,0),v=0,E=!1,V=null,w=null,P=null,O=null,B=null,mt.set(0,0,n.canvas.width,n.canvas.height),It.set(0,0,n.canvas.width,n.canvas.height),o.reset(),r.reset(),a.reset()}return{buffers:{color:o,depth:r,stencil:a},enable:it,disable:rt,bindFramebuffer:Ut,drawBuffers:Rt,useProgram:Ft,setBlending:oe,setMaterial:fe,setFlipSided:Vt,setCullFace:Ce,setLineWidth:D,setPolygonOffset:De,setScissorTest:se,activeTexture:me,bindTexture:St,unbindTexture:R,compressedTexImage2D:b,compressedTexImage3D:z,texImage2D:Dt,texImage3D:Q,updateUBOMapping:bt,uniformBlockBinding:dt,texStorage2D:at,texStorage3D:wt,texSubImage2D:$,texSubImage3D:Z,compressedTexSubImage2D:j,compressedTexSubImage3D:gt,scissor:st,viewport:_t,reset:Ht}}function Tb(n,t,e,i,s,o,r){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Mt,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(R,b){return f?new OffscreenCanvas(R,b):Kr("canvas")}function _(R,b,z){let $=1;const Z=St(R);if((Z.width>z||Z.height>z)&&($=z/Math.max(Z.width,Z.height)),$<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const j=Math.floor($*Z.width),gt=Math.floor($*Z.height);u===void 0&&(u=m(j,gt));const at=b?m(j,gt):u;return at.width=j,at.height=gt,at.getContext("2d").drawImage(R,0,0,j,gt),Lt("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+j+"x"+gt+")."),at}else return"data"in R&&Lt("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),R;return R}function p(R){return R.generateMipmaps}function g(R){n.generateMipmap(R)}function x(R){return R.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?n.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function y(R,b,z,$,Z=!1){if(R!==null){if(n[R]!==void 0)return n[R];Lt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let j=b;if(b===n.RED&&(z===n.FLOAT&&(j=n.R32F),z===n.HALF_FLOAT&&(j=n.R16F),z===n.UNSIGNED_BYTE&&(j=n.R8)),b===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(j=n.R8UI),z===n.UNSIGNED_SHORT&&(j=n.R16UI),z===n.UNSIGNED_INT&&(j=n.R32UI),z===n.BYTE&&(j=n.R8I),z===n.SHORT&&(j=n.R16I),z===n.INT&&(j=n.R32I)),b===n.RG&&(z===n.FLOAT&&(j=n.RG32F),z===n.HALF_FLOAT&&(j=n.RG16F),z===n.UNSIGNED_BYTE&&(j=n.RG8)),b===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(j=n.RG8UI),z===n.UNSIGNED_SHORT&&(j=n.RG16UI),z===n.UNSIGNED_INT&&(j=n.RG32UI),z===n.BYTE&&(j=n.RG8I),z===n.SHORT&&(j=n.RG16I),z===n.INT&&(j=n.RG32I)),b===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(j=n.RGB8UI),z===n.UNSIGNED_SHORT&&(j=n.RGB16UI),z===n.UNSIGNED_INT&&(j=n.RGB32UI),z===n.BYTE&&(j=n.RGB8I),z===n.SHORT&&(j=n.RGB16I),z===n.INT&&(j=n.RGB32I)),b===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(j=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(j=n.RGBA16UI),z===n.UNSIGNED_INT&&(j=n.RGBA32UI),z===n.BYTE&&(j=n.RGBA8I),z===n.SHORT&&(j=n.RGBA16I),z===n.INT&&(j=n.RGBA32I)),b===n.RGB&&(z===n.UNSIGNED_INT_5_9_9_9_REV&&(j=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(j=n.R11F_G11F_B10F)),b===n.RGBA){const gt=Z?$r:Qt.getTransfer($);z===n.FLOAT&&(j=n.RGBA32F),z===n.HALF_FLOAT&&(j=n.RGBA16F),z===n.UNSIGNED_BYTE&&(j=gt===ae?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT_4_4_4_4&&(j=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(j=n.RGB5_A1)}return(j===n.R16F||j===n.R32F||j===n.RG16F||j===n.RG32F||j===n.RGBA16F||j===n.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function M(R,b){let z;return R?b===null||b===$n||b===Oo?z=n.DEPTH24_STENCIL8:b===Gn?z=n.DEPTH32F_STENCIL8:b===Fo&&(z=n.DEPTH24_STENCIL8,Lt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===$n||b===Oo?z=n.DEPTH_COMPONENT24:b===Gn?z=n.DEPTH_COMPONENT32F:b===Fo&&(z=n.DEPTH_COMPONENT16),z}function T(R,b){return p(R)===!0||R.isFramebufferTexture&&R.minFilter!==$e&&R.minFilter!==rn?Math.log2(Math.max(b.width,b.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?b.mipmaps.length:1}function A(R){const b=R.target;b.removeEventListener("dispose",A),v(b),b.isVideoTexture&&h.delete(b)}function C(R){const b=R.target;b.removeEventListener("dispose",C),V(b)}function v(R){const b=i.get(R);if(b.__webglInit===void 0)return;const z=R.source,$=d.get(z);if($){const Z=$[b.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&E(R),Object.keys($).length===0&&d.delete(z)}i.remove(R)}function E(R){const b=i.get(R);n.deleteTexture(b.__webglTexture);const z=R.source,$=d.get(z);delete $[b.__cacheKey],r.memory.textures--}function V(R){const b=i.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),i.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(b.__webglFramebuffer[$]))for(let Z=0;Z<b.__webglFramebuffer[$].length;Z++)n.deleteFramebuffer(b.__webglFramebuffer[$][Z]);else n.deleteFramebuffer(b.__webglFramebuffer[$]);b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer[$])}else{if(Array.isArray(b.__webglFramebuffer))for(let $=0;$<b.__webglFramebuffer.length;$++)n.deleteFramebuffer(b.__webglFramebuffer[$]);else n.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&n.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let $=0;$<b.__webglColorRenderbuffer.length;$++)b.__webglColorRenderbuffer[$]&&n.deleteRenderbuffer(b.__webglColorRenderbuffer[$]);b.__webglDepthRenderbuffer&&n.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const z=R.textures;for(let $=0,Z=z.length;$<Z;$++){const j=i.get(z[$]);j.__webglTexture&&(n.deleteTexture(j.__webglTexture),r.memory.textures--),i.remove(z[$])}i.remove(R)}let w=0;function P(){w=0}function O(){const R=w;return R>=s.maxTextures&&Lt("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+s.maxTextures),w+=1,R}function B(R){const b=[];return b.push(R.wrapS),b.push(R.wrapT),b.push(R.wrapR||0),b.push(R.magFilter),b.push(R.minFilter),b.push(R.anisotropy),b.push(R.internalFormat),b.push(R.format),b.push(R.type),b.push(R.generateMipmaps),b.push(R.premultiplyAlpha),b.push(R.flipY),b.push(R.unpackAlignment),b.push(R.colorSpace),b.join()}function I(R,b){const z=i.get(R);if(R.isVideoTexture&&se(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&z.__version!==R.version){const $=R.image;if($===null)Lt("WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)Lt("WebGLRenderer: Texture marked for update but image is incomplete");else{X(z,R,b);return}}else R.isExternalTexture&&(z.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+b)}function U(R,b){const z=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&z.__version!==R.version){X(z,R,b);return}else R.isExternalTexture&&(z.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+b)}function L(R,b){const z=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&z.__version!==R.version){X(z,R,b);return}e.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+b)}function K(R,b){const z=i.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&z.__version!==R.version){it(z,R,b);return}e.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+b)}const Y={[Fl]:n.REPEAT,[di]:n.CLAMP_TO_EDGE,[Ol]:n.MIRRORED_REPEAT},J={[$e]:n.NEAREST,[Am]:n.NEAREST_MIPMAP_NEAREST,[Jo]:n.NEAREST_MIPMAP_LINEAR,[rn]:n.LINEAR,[Aa]:n.LINEAR_MIPMAP_NEAREST,[hs]:n.LINEAR_MIPMAP_LINEAR},nt={[Rm]:n.NEVER,[Fm]:n.ALWAYS,[Pm]:n.LESS,[Bc]:n.LEQUAL,[Dm]:n.EQUAL,[zc]:n.GEQUAL,[Lm]:n.GREATER,[Im]:n.NOTEQUAL};function et(R,b){if(b.type===Gn&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===rn||b.magFilter===Aa||b.magFilter===Jo||b.magFilter===hs||b.minFilter===rn||b.minFilter===Aa||b.minFilter===Jo||b.minFilter===hs)&&Lt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(R,n.TEXTURE_WRAP_S,Y[b.wrapS]),n.texParameteri(R,n.TEXTURE_WRAP_T,Y[b.wrapT]),(R===n.TEXTURE_3D||R===n.TEXTURE_2D_ARRAY)&&n.texParameteri(R,n.TEXTURE_WRAP_R,Y[b.wrapR]),n.texParameteri(R,n.TEXTURE_MAG_FILTER,J[b.magFilter]),n.texParameteri(R,n.TEXTURE_MIN_FILTER,J[b.minFilter]),b.compareFunction&&(n.texParameteri(R,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(R,n.TEXTURE_COMPARE_FUNC,nt[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===$e||b.minFilter!==Jo&&b.minFilter!==hs||b.type===Gn&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){const z=t.get("EXT_texture_filter_anisotropic");n.texParameterf(R,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function mt(R,b){let z=!1;R.__webglInit===void 0&&(R.__webglInit=!0,b.addEventListener("dispose",A));const $=b.source;let Z=d.get($);Z===void 0&&(Z={},d.set($,Z));const j=B(b);if(j!==R.__cacheKey){Z[j]===void 0&&(Z[j]={texture:n.createTexture(),usedTimes:0},r.memory.textures++,z=!0),Z[j].usedTimes++;const gt=Z[R.__cacheKey];gt!==void 0&&(Z[R.__cacheKey].usedTimes--,gt.usedTimes===0&&E(b)),R.__cacheKey=j,R.__webglTexture=Z[j].texture}return z}function It(R,b,z){return Math.floor(Math.floor(R/z)/b)}function jt(R,b,z,$){const j=R.updateRanges;if(j.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,b.width,b.height,z,$,b.data);else{j.sort((Q,st)=>Q.start-st.start);let gt=0;for(let Q=1;Q<j.length;Q++){const st=j[gt],_t=j[Q],bt=st.start+st.count,dt=It(_t.start,b.width,4),Ht=It(st.start,b.width,4);_t.start<=bt+1&&dt===Ht&&It(_t.start+_t.count-1,b.width,4)===dt?st.count=Math.max(st.count,_t.start+_t.count-st.start):(++gt,j[gt]=_t)}j.length=gt+1;const at=n.getParameter(n.UNPACK_ROW_LENGTH),wt=n.getParameter(n.UNPACK_SKIP_PIXELS),Dt=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,b.width);for(let Q=0,st=j.length;Q<st;Q++){const _t=j[Q],bt=Math.floor(_t.start/4),dt=Math.ceil(_t.count/4),Ht=bt%b.width,N=Math.floor(bt/b.width),lt=dt,ot=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Ht),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),e.texSubImage2D(n.TEXTURE_2D,0,Ht,N,lt,ot,z,$,b.data)}R.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,at),n.pixelStorei(n.UNPACK_SKIP_PIXELS,wt),n.pixelStorei(n.UNPACK_SKIP_ROWS,Dt)}}function X(R,b,z){let $=n.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&($=n.TEXTURE_2D_ARRAY),b.isData3DTexture&&($=n.TEXTURE_3D);const Z=mt(R,b),j=b.source;e.bindTexture($,R.__webglTexture,n.TEXTURE0+z);const gt=i.get(j);if(j.version!==gt.__version||Z===!0){e.activeTexture(n.TEXTURE0+z);const at=Qt.getPrimaries(Qt.workingColorSpace),wt=b.colorSpace===Li?null:Qt.getPrimaries(b.colorSpace),Dt=b.colorSpace===Li||at===wt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Dt);let Q=_(b.image,!1,s.maxTextureSize);Q=me(b,Q);const st=o.convert(b.format,b.colorSpace),_t=o.convert(b.type);let bt=y(b.internalFormat,st,_t,b.colorSpace,b.isVideoTexture);et($,b);let dt;const Ht=b.mipmaps,N=b.isVideoTexture!==!0,lt=gt.__version===void 0||Z===!0,ot=j.dataReady,pt=T(b,Q);if(b.isDepthTexture)bt=M(b.format===us,b.type),lt&&(N?e.texStorage2D(n.TEXTURE_2D,1,bt,Q.width,Q.height):e.texImage2D(n.TEXTURE_2D,0,bt,Q.width,Q.height,0,st,_t,null));else if(b.isDataTexture)if(Ht.length>0){N&&lt&&e.texStorage2D(n.TEXTURE_2D,pt,bt,Ht[0].width,Ht[0].height);for(let tt=0,q=Ht.length;tt<q;tt++)dt=Ht[tt],N?ot&&e.texSubImage2D(n.TEXTURE_2D,tt,0,0,dt.width,dt.height,st,_t,dt.data):e.texImage2D(n.TEXTURE_2D,tt,bt,dt.width,dt.height,0,st,_t,dt.data);b.generateMipmaps=!1}else N?(lt&&e.texStorage2D(n.TEXTURE_2D,pt,bt,Q.width,Q.height),ot&&jt(b,Q,st,_t)):e.texImage2D(n.TEXTURE_2D,0,bt,Q.width,Q.height,0,st,_t,Q.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){N&&lt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,pt,bt,Ht[0].width,Ht[0].height,Q.depth);for(let tt=0,q=Ht.length;tt<q;tt++)if(dt=Ht[tt],b.format!==Fn)if(st!==null)if(N){if(ot)if(b.layerUpdates.size>0){const xt=eu(dt.width,dt.height,b.format,b.type);for(const Ot of b.layerUpdates){const ge=dt.data.subarray(Ot*xt/dt.data.BYTES_PER_ELEMENT,(Ot+1)*xt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,tt,0,0,Ot,dt.width,dt.height,1,st,ge)}b.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,tt,0,0,0,dt.width,dt.height,Q.depth,st,dt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,tt,bt,dt.width,dt.height,Q.depth,0,dt.data,0,0);else Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?ot&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,tt,0,0,0,dt.width,dt.height,Q.depth,st,_t,dt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,tt,bt,dt.width,dt.height,Q.depth,0,st,_t,dt.data)}else{N&&lt&&e.texStorage2D(n.TEXTURE_2D,pt,bt,Ht[0].width,Ht[0].height);for(let tt=0,q=Ht.length;tt<q;tt++)dt=Ht[tt],b.format!==Fn?st!==null?N?ot&&e.compressedTexSubImage2D(n.TEXTURE_2D,tt,0,0,dt.width,dt.height,st,dt.data):e.compressedTexImage2D(n.TEXTURE_2D,tt,bt,dt.width,dt.height,0,dt.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?ot&&e.texSubImage2D(n.TEXTURE_2D,tt,0,0,dt.width,dt.height,st,_t,dt.data):e.texImage2D(n.TEXTURE_2D,tt,bt,dt.width,dt.height,0,st,_t,dt.data)}else if(b.isDataArrayTexture)if(N){if(lt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,pt,bt,Q.width,Q.height,Q.depth),ot)if(b.layerUpdates.size>0){const tt=eu(Q.width,Q.height,b.format,b.type);for(const q of b.layerUpdates){const xt=Q.data.subarray(q*tt/Q.data.BYTES_PER_ELEMENT,(q+1)*tt/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,q,Q.width,Q.height,1,st,_t,xt)}b.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,st,_t,Q.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,bt,Q.width,Q.height,Q.depth,0,st,_t,Q.data);else if(b.isData3DTexture)N?(lt&&e.texStorage3D(n.TEXTURE_3D,pt,bt,Q.width,Q.height,Q.depth),ot&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,st,_t,Q.data)):e.texImage3D(n.TEXTURE_3D,0,bt,Q.width,Q.height,Q.depth,0,st,_t,Q.data);else if(b.isFramebufferTexture){if(lt)if(N)e.texStorage2D(n.TEXTURE_2D,pt,bt,Q.width,Q.height);else{let tt=Q.width,q=Q.height;for(let xt=0;xt<pt;xt++)e.texImage2D(n.TEXTURE_2D,xt,bt,tt,q,0,st,_t,null),tt>>=1,q>>=1}}else if(Ht.length>0){if(N&&lt){const tt=St(Ht[0]);e.texStorage2D(n.TEXTURE_2D,pt,bt,tt.width,tt.height)}for(let tt=0,q=Ht.length;tt<q;tt++)dt=Ht[tt],N?ot&&e.texSubImage2D(n.TEXTURE_2D,tt,0,0,st,_t,dt):e.texImage2D(n.TEXTURE_2D,tt,bt,st,_t,dt);b.generateMipmaps=!1}else if(N){if(lt){const tt=St(Q);e.texStorage2D(n.TEXTURE_2D,pt,bt,tt.width,tt.height)}ot&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,st,_t,Q)}else e.texImage2D(n.TEXTURE_2D,0,bt,st,_t,Q);p(b)&&g($),gt.__version=j.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function it(R,b,z){if(b.image.length!==6)return;const $=mt(R,b),Z=b.source;e.bindTexture(n.TEXTURE_CUBE_MAP,R.__webglTexture,n.TEXTURE0+z);const j=i.get(Z);if(Z.version!==j.__version||$===!0){e.activeTexture(n.TEXTURE0+z);const gt=Qt.getPrimaries(Qt.workingColorSpace),at=b.colorSpace===Li?null:Qt.getPrimaries(b.colorSpace),wt=b.colorSpace===Li||gt===at?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,wt);const Dt=b.isCompressedTexture||b.image[0].isCompressedTexture,Q=b.image[0]&&b.image[0].isDataTexture,st=[];for(let q=0;q<6;q++)!Dt&&!Q?st[q]=_(b.image[q],!0,s.maxCubemapSize):st[q]=Q?b.image[q].image:b.image[q],st[q]=me(b,st[q]);const _t=st[0],bt=o.convert(b.format,b.colorSpace),dt=o.convert(b.type),Ht=y(b.internalFormat,bt,dt,b.colorSpace),N=b.isVideoTexture!==!0,lt=j.__version===void 0||$===!0,ot=Z.dataReady;let pt=T(b,_t);et(n.TEXTURE_CUBE_MAP,b);let tt;if(Dt){N&&lt&&e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,_t.width,_t.height);for(let q=0;q<6;q++){tt=st[q].mipmaps;for(let xt=0;xt<tt.length;xt++){const Ot=tt[xt];b.format!==Fn?bt!==null?N?ot&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,0,0,Ot.width,Ot.height,bt,Ot.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,Ht,Ot.width,Ot.height,0,Ot.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,0,0,Ot.width,Ot.height,bt,dt,Ot.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt,Ht,Ot.width,Ot.height,0,bt,dt,Ot.data)}}}else{if(tt=b.mipmaps,N&&lt){tt.length>0&&pt++;const q=St(st[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,q.width,q.height)}for(let q=0;q<6;q++)if(Q){N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,st[q].width,st[q].height,bt,dt,st[q].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Ht,st[q].width,st[q].height,0,bt,dt,st[q].data);for(let xt=0;xt<tt.length;xt++){const ge=tt[xt].image[q].image;N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,0,0,ge.width,ge.height,bt,dt,ge.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,Ht,ge.width,ge.height,0,bt,dt,ge.data)}}else{N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,bt,dt,st[q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Ht,bt,dt,st[q]);for(let xt=0;xt<tt.length;xt++){const Ot=tt[xt];N?ot&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,0,0,bt,dt,Ot.image[q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,xt+1,Ht,bt,dt,Ot.image[q])}}}p(b)&&g(n.TEXTURE_CUBE_MAP),j.__version=Z.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function rt(R,b,z,$,Z,j){const gt=o.convert(z.format,z.colorSpace),at=o.convert(z.type),wt=y(z.internalFormat,gt,at,z.colorSpace),Dt=i.get(b),Q=i.get(z);if(Q.__renderTarget=b,!Dt.__hasExternalTextures){const st=Math.max(1,b.width>>j),_t=Math.max(1,b.height>>j);Z===n.TEXTURE_3D||Z===n.TEXTURE_2D_ARRAY?e.texImage3D(Z,j,wt,st,_t,b.depth,0,gt,at,null):e.texImage2D(Z,j,wt,st,_t,0,gt,at,null)}e.bindFramebuffer(n.FRAMEBUFFER,R),De(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,$,Z,Q.__webglTexture,0,D(b)):(Z===n.TEXTURE_2D||Z>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,$,Z,Q.__webglTexture,j),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Ut(R,b,z){if(n.bindRenderbuffer(n.RENDERBUFFER,R),b.depthBuffer){const $=b.depthTexture,Z=$&&$.isDepthTexture?$.type:null,j=M(b.stencilBuffer,Z),gt=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;De(b)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(b),j,b.width,b.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(b),j,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,j,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,gt,n.RENDERBUFFER,R)}else{const $=b.textures;for(let Z=0;Z<$.length;Z++){const j=$[Z],gt=o.convert(j.format,j.colorSpace),at=o.convert(j.type),wt=y(j.internalFormat,gt,at,j.colorSpace);De(b)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,D(b),wt,b.width,b.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,D(b),wt,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,wt,b.width,b.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Rt(R,b,z){const $=b.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(n.FRAMEBUFFER,R),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=i.get(b.depthTexture);if(Z.__renderTarget=b,(!Z.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),$){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,b.depthTexture.addEventListener("dispose",A)),Z.__webglTexture===void 0){Z.__webglTexture=n.createTexture(),e.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),et(n.TEXTURE_CUBE_MAP,b.depthTexture);const Dt=o.convert(b.depthTexture.format),Q=o.convert(b.depthTexture.type);let st;b.depthTexture.format===vi?st=n.DEPTH_COMPONENT24:b.depthTexture.format===us&&(st=n.DEPTH24_STENCIL8);for(let _t=0;_t<6;_t++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,st,b.width,b.height,0,Dt,Q,null)}}else I(b.depthTexture,0);const j=Z.__webglTexture,gt=D(b),at=$?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,wt=b.depthTexture.format===us?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(b.depthTexture.format===vi)De(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,wt,at,j,0,gt):n.framebufferTexture2D(n.FRAMEBUFFER,wt,at,j,0);else if(b.depthTexture.format===us)De(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,wt,at,j,0,gt):n.framebufferTexture2D(n.FRAMEBUFFER,wt,at,j,0);else throw new Error("Unknown depthTexture format")}function Ft(R){const b=i.get(R),z=R.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==R.depthTexture){const $=R.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),$){const Z=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,$.removeEventListener("dispose",Z)};$.addEventListener("dispose",Z),b.__depthDisposeCallback=Z}b.__boundDepthTexture=$}if(R.depthTexture&&!b.__autoAllocateDepthBuffer)if(z)for(let $=0;$<6;$++)Rt(b.__webglFramebuffer[$],R,$);else{const $=R.texture.mipmaps;$&&$.length>0?Rt(b.__webglFramebuffer[0],R,0):Rt(b.__webglFramebuffer,R,0)}else if(z){b.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[$]),b.__webglDepthbuffer[$]===void 0)b.__webglDepthbuffer[$]=n.createRenderbuffer(),Ut(b.__webglDepthbuffer[$],R,!1);else{const Z=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,j=b.__webglDepthbuffer[$];n.bindRenderbuffer(n.RENDERBUFFER,j),n.framebufferRenderbuffer(n.FRAMEBUFFER,Z,n.RENDERBUFFER,j)}}else{const $=R.texture.mipmaps;if($&&$.length>0?e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=n.createRenderbuffer(),Ut(b.__webglDepthbuffer,R,!1);else{const Z=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,j=b.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,j),n.framebufferRenderbuffer(n.FRAMEBUFFER,Z,n.RENDERBUFFER,j)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function We(R,b,z){const $=i.get(R);b!==void 0&&rt($.__webglFramebuffer,R,R.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&Ft(R)}function Zt(R){const b=R.texture,z=i.get(R),$=i.get(b);R.addEventListener("dispose",C);const Z=R.textures,j=R.isWebGLCubeRenderTarget===!0,gt=Z.length>1;if(gt||($.__webglTexture===void 0&&($.__webglTexture=n.createTexture()),$.__version=b.version,r.memory.textures++),j){z.__webglFramebuffer=[];for(let at=0;at<6;at++)if(b.mipmaps&&b.mipmaps.length>0){z.__webglFramebuffer[at]=[];for(let wt=0;wt<b.mipmaps.length;wt++)z.__webglFramebuffer[at][wt]=n.createFramebuffer()}else z.__webglFramebuffer[at]=n.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){z.__webglFramebuffer=[];for(let at=0;at<b.mipmaps.length;at++)z.__webglFramebuffer[at]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(gt)for(let at=0,wt=Z.length;at<wt;at++){const Dt=i.get(Z[at]);Dt.__webglTexture===void 0&&(Dt.__webglTexture=n.createTexture(),r.memory.textures++)}if(R.samples>0&&De(R)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let at=0;at<Z.length;at++){const wt=Z[at];z.__webglColorRenderbuffer[at]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[at]);const Dt=o.convert(wt.format,wt.colorSpace),Q=o.convert(wt.type),st=y(wt.internalFormat,Dt,Q,wt.colorSpace,R.isXRRenderTarget===!0),_t=D(R);n.renderbufferStorageMultisample(n.RENDERBUFFER,_t,st,R.width,R.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.RENDERBUFFER,z.__webglColorRenderbuffer[at])}n.bindRenderbuffer(n.RENDERBUFFER,null),R.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),Ut(z.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(j){e.bindTexture(n.TEXTURE_CUBE_MAP,$.__webglTexture),et(n.TEXTURE_CUBE_MAP,b);for(let at=0;at<6;at++)if(b.mipmaps&&b.mipmaps.length>0)for(let wt=0;wt<b.mipmaps.length;wt++)rt(z.__webglFramebuffer[at][wt],R,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,wt);else rt(z.__webglFramebuffer[at],R,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(b)&&g(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(gt){for(let at=0,wt=Z.length;at<wt;at++){const Dt=Z[at],Q=i.get(Dt);let st=n.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(st=R.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(st,Q.__webglTexture),et(st,Dt),rt(z.__webglFramebuffer,R,Dt,n.COLOR_ATTACHMENT0+at,st,0),p(Dt)&&g(st)}e.unbindTexture()}else{let at=n.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(at=R.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(at,$.__webglTexture),et(at,b),b.mipmaps&&b.mipmaps.length>0)for(let wt=0;wt<b.mipmaps.length;wt++)rt(z.__webglFramebuffer[wt],R,b,n.COLOR_ATTACHMENT0,at,wt);else rt(z.__webglFramebuffer,R,b,n.COLOR_ATTACHMENT0,at,0);p(b)&&g(at),e.unbindTexture()}R.depthBuffer&&Ft(R)}function oe(R){const b=R.textures;for(let z=0,$=b.length;z<$;z++){const Z=b[z];if(p(Z)){const j=x(R),gt=i.get(Z).__webglTexture;e.bindTexture(j,gt),g(j),e.unbindTexture()}}}const fe=[],Vt=[];function Ce(R){if(R.samples>0){if(De(R)===!1){const b=R.textures,z=R.width,$=R.height;let Z=n.COLOR_BUFFER_BIT;const j=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,gt=i.get(R),at=b.length>1;if(at)for(let Dt=0;Dt<b.length;Dt++)e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);const wt=R.texture.mipmaps;wt&&wt.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let Dt=0;Dt<b.length;Dt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(Z|=n.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(Z|=n.STENCIL_BUFFER_BIT)),at){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,gt.__webglColorRenderbuffer[Dt]);const Q=i.get(b[Dt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Q,0)}n.blitFramebuffer(0,0,z,$,0,0,z,$,Z,n.NEAREST),l===!0&&(fe.length=0,Vt.length=0,fe.push(n.COLOR_ATTACHMENT0+Dt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(fe.push(j),Vt.push(j),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Vt)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,fe))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),at)for(let Dt=0;Dt<b.length;Dt++){e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.RENDERBUFFER,gt.__webglColorRenderbuffer[Dt]);const Q=i.get(b[Dt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,gt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Dt,n.TEXTURE_2D,Q,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const b=R.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[b])}}}function D(R){return Math.min(s.maxSamples,R.samples)}function De(R){const b=i.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function se(R){const b=r.render.frame;h.get(R)!==b&&(h.set(R,b),R.update())}function me(R,b){const z=R.colorSpace,$=R.format,Z=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||z!==qs&&z!==Li&&(Qt.getTransfer(z)===ae?($!==Fn||Z!==Mn)&&Lt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ne("WebGLTextures: Unsupported texture color space:",z)),b}function St(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=P,this.setTexture2D=I,this.setTexture2DArray=U,this.setTexture3D=L,this.setTextureCube=K,this.rebindTextures=We,this.setupRenderTarget=Zt,this.updateRenderTargetMipmap=oe,this.updateMultisampleRenderTarget=Ce,this.setupDepthRenderbuffer=Ft,this.setupFrameBufferTexture=rt,this.useMultisampledRTT=De,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Ab(n,t){function e(i,s=Li){let o;const r=Qt.getTransfer(s);if(i===Mn)return n.UNSIGNED_BYTE;if(i===Ic)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Fc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===_f)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===xf)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===mf)return n.BYTE;if(i===gf)return n.SHORT;if(i===Fo)return n.UNSIGNED_SHORT;if(i===Lc)return n.INT;if(i===$n)return n.UNSIGNED_INT;if(i===Gn)return n.FLOAT;if(i===xi)return n.HALF_FLOAT;if(i===vf)return n.ALPHA;if(i===bf)return n.RGB;if(i===Fn)return n.RGBA;if(i===vi)return n.DEPTH_COMPONENT;if(i===us)return n.DEPTH_STENCIL;if(i===yf)return n.RED;if(i===Oc)return n.RED_INTEGER;if(i===Ys)return n.RG;if(i===Nc)return n.RG_INTEGER;if(i===Uc)return n.RGBA_INTEGER;if(i===Vr||i===Hr||i===Gr||i===Wr)if(r===ae)if(o=t.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(i===Vr)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Hr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Gr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Wr)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=t.get("WEBGL_compressed_texture_s3tc"),o!==null){if(i===Vr)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Hr)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Gr)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Wr)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Nl||i===Ul||i===Bl||i===zl)if(o=t.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(i===Nl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ul)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Bl)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===zl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===kl||i===Vl||i===Hl||i===Gl||i===Wl||i===Xl||i===Yl)if(o=t.get("WEBGL_compressed_texture_etc"),o!==null){if(i===kl||i===Vl)return r===ae?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(i===Hl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC;if(i===Gl)return o.COMPRESSED_R11_EAC;if(i===Wl)return o.COMPRESSED_SIGNED_R11_EAC;if(i===Xl)return o.COMPRESSED_RG11_EAC;if(i===Yl)return o.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===ql||i===jl||i===$l||i===Kl||i===Zl||i===Jl||i===Ql||i===tc||i===ec||i===nc||i===ic||i===sc||i===oc||i===rc)if(o=t.get("WEBGL_compressed_texture_astc"),o!==null){if(i===ql)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===jl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===$l)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Kl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Zl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Jl)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ql)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===tc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ec)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===nc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ic)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===sc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===oc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===rc)return r===ae?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ac||i===lc||i===cc)if(o=t.get("EXT_texture_compression_bptc"),o!==null){if(i===ac)return r===ae?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===lc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===cc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===hc||i===uc||i===dc||i===fc)if(o=t.get("EXT_texture_compression_rgtc"),o!==null){if(i===hc)return o.COMPRESSED_RED_RGTC1_EXT;if(i===uc)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===dc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===fc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Oo?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const wb=`
void main() {
